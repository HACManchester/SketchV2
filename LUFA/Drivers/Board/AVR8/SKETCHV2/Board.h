...
/** \file
 *  \brief Board specific information header for the SKETCHV2.
 *  \copydetails Group_BoardInfo_SKETCHV2
 *
 ...
 *  \defgroup Group_BoardInfo_SKETCHV2 SKETCHV2
 *  \brief Board specific information header for the SKETCHV2.
 *
 *  Board specific information header for the SKETCHV2.
 *
 *  @{
 */

#ifndef __BOARD_SKETCHV2_H__
#define __BOARD_SKETCHV2_H__
